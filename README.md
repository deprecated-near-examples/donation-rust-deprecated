...
[![](https://img.shields.io/github/workflow/status/near-examples/donation-rust/Tests/main?color=green&label=Tests)](https://github.com/near-examples/donation-rust/actions/workflows/tests.yml)
